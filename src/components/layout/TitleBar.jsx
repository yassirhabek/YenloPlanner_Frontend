...
function TitleBar() {
  ...
  return (
    <header className={classes.header} >
      <img src={YenloLogo} width="200" height="75" alt="Yenlo Logo" className={classes.logo}/>
        <SearchBar placeholder="Search Employee..." data={Data} />
        <img src={Uitloggen} width="50" height="50" alt="Uitloggen" onClick={logOutHandler} className={classes.logout}/>
    </header>
  );
}
